...
//        documentManager.saveDocuments(documentService.getDocuments());
    ...
    public ArrayList<DocumentVersion> getAllVersions() {
        return versions;
    }
...
//    //found that this has bug with accessing index. get(i) actually gets the version-1 because it starts from 0. Went with stream instead
//        if(versions.isEmpty()) {
    ...
    public String getVersionContent(int versionNumber) {
        return versions.stream()
                ...
                //.orElseThrow(() -> new IllegalArgumentException(
                        //"No version was found with the version number: " + versionNumber));
    }
